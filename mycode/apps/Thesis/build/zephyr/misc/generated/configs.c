...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_SCIOSENSE_ENS160_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENS160, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENS160_TRIGGER_NONE, 1);
