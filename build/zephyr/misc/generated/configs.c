...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FS_LOG_LEVEL, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT2_MAX_FILES, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT2_MAX_BLOCK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT2_MAX_BLOCK_COUNT, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT2_DISK_STARTING_SECTOR, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT2_SUPERBLOCK_ALIGNMENT, 1);
